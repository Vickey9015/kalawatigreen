    ...
    <section className="relative overflow-hidden py-24 sm:py-32">
      ...
      <Reveal>
        <div className="kg-on-image relative mx-auto max-w-3xl px-4 text-center text-white sm:px-6">
          ...
          <h2 className="kg-display-title mt-4 text-4xl text-white sm:text-5xl">{homeBooking.title}</h2>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <Link href="/contact?intent=event" className="rounded-sm border border-white/50 px-6 py-3 text-xs font-bold uppercase tracking-[0.16em] text-white backdrop-blur-md">
