...
export default function AdminShell({ children }: { children: ReactNode }) {
  ...
  if (authed !== true) {
    return (
      <div className="admin-shell flex min-h-screen items-center justify-center px-4">
        <div className="rounded-2xl border border-[rgba(1,49,31,0.14)] bg-white/90 px-6 py-5 text-sm text-kg-muted">
  ...
  return (
    <div className="admin-shell min-h-screen text-kg-text">
      <div
        className={`fixed inset-0 z-40 bg-[rgba(1,49,31,0.45)] backdrop-blur-[2px] transition-opacity lg:hidden ${
      ...
      >
        <div className="border-b border-white/10 px-5 py-6">
          <Link href="/admin/" className="group block">
            <span className="flex items-center gap-3">
              ...
              />
              <span>
                <span className="block text-[0.7rem] font-semibold tracking-[0.22em] text-[#d4bc78]">
                  KALAWATI GREENS
                </span>
            ...
            return (
              <Link
                ...
                className={`admin-nav-link group flex items-start gap-3 rounded-xl px-3 py-2.5 transition ${
                  active
                    ? "bg-kg-green-light/40 text-white ring-1 ring-[#d4bc78]/40"
        ...
        <div className="space-y-2 border-t border-white/10 p-4">
          ...
          >
            ...
            <span aria-hidden className="text-[#d4bc78]">
              ↗
            </span>
          </Link>
          <button
      ...
      <div className="lg:pl-[17.5rem]">
        <header className="sticky top-0 z-30 border-b border-[rgba(1,49,31,0.14)] bg-[rgba(243,242,237,0.88)] backdrop-blur-md">
          <div className="flex items-center justify-between gap-4 px-4 py-3.5 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3">
              <button
                type="button"
                className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-[rgba(1,49,31,0.18)] bg-white text-kg-green lg:hidden"
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <span className="hidden items-center gap-2 rounded-full border border-[rgba(1,49,31,0.16)] bg-white/90 px-3 py-1.5 text-xs text-kg-green sm:inline-flex">
              ...
              <button
                type="button"
                onClick={handleLogout}
                className="hidden rounded-lg border border-[rgba(1,49,31,0.16)] bg-white px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.1em] text-kg-green transition hover:bg-[rgba(1,49,31,0.06)] sm:inline-flex"
              >
                Sign out
              </button>
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-kg-green text-[0.7rem] font-bold text-white ring-2 ring-[rgba(13,74,56,0.25)]">
                KG
              </div>
            </div>
          </div>
